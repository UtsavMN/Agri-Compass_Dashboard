...
const farmLocations = [
  {
    ...
    color: "#7EC47E",
    description:
      "Enter your soil NPK values and watch the AI recommend the crop most likely to succeed on your land. Real-time confidence scoring.",
  ...
  },
  {
    ...
    color: "#E5D08F",
    description:
      "Visualise your soil health as a vitality score. Get exact fertilizer quantities — not estimates. Chemistry, not guesswork.",
  ...
  },
  {
    ...
    color: "#F5F0E8",
    description:
      "Live animated weather from OpenWeather. See how humidity, wind, and rain predictions translate into farming advisories.",
  ...
  },
  {
    ...
    color: "#6090E0",
    description:
      "Real-time APMC prices from Data.gov.in. Compare your crop's current price vs MSP. Interactive profitability charts.",
  ...
  },
  {
    ...
    color: "#E5D08F",
    description:
      "Ask any farming question in Kannada or English. Powered by Google Gemini with farm-specific context injected server-side.",
    interactive: "ai-chat",
  ...
  },
  {
    ...
    color: "#E0C060",
    description:
      "No typing needed. Speak naturally in Kannada. The app understands, responds, and navigates — on any Android phone.",
  ...
  },
  {
    ...
    color: "#7EC47E",
    description:
      "A real social platform. Share knowledge. Follow farmers in your district. Chat in real-time via WebSocket messaging.",
  ...
  },
  {
    ...
    color: "#E5D08F",
    description:
      "Detailed crop guides covering land preparation, sowing, irrigation, fertilizer schedules, pest control, and harvesting.",
  ...
  return (
    <div className="space-y-5">
      ...
      <motion.div
        ...
        className="premium-card bg-[#0A0603]/40 p-4 mt-2"
        role="status"
        aria-live="polite"
      >
...
const AIChatDemo = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="premium-card bg-[#0A0603]/30 p-4 min-h-[100px]" role="status" aria-live="polite">
        <div className="flex items-center gap-2 mb-3">
          <div className="w-5 h-5 bg-[#E5D08F]/15 rounded-md flex items-center justify-center text-xs" aria-hidden="true">🤖</div>
            ...
            <div className="flex gap-1 ml-2" aria-label="Krishi Mitra is typing" aria-busy="true">
              {[0, 1, 2].map(i => (
                <motion.div key={i}
                  ...
                  className="w-1 h-1 bg-[#E5D08F]/50 rounded-full"
                />
              ))}
            </div>
          )}
      ...
      {posts.map((post, i) => (
        ...
        >
          <div className="flex items-center gap-2.5 mb-2.5">
            <div className="w-7 h-7 rounded-full bg-[#E5D08F]/15 border border-[#E5D08F]/25
                            flex items-center justify-center text-xs font-semibold text-[#E5D08F]" aria-hidden="true">
              {post.avatar}
            </div>
            <div>
      ...
      <div className="space-y-3 pl-12">
        {stages.map((stage, i) => (
          <motion.div key={i}
            ...
            className="relative"
          >
            <div className="absolute -left-7 w-5 h-5 rounded-full bg-[#111008] border border-[#E5D08F]/30
                            flex items-center justify-center text-xs" aria-hidden="true">
              {stage.icon}
            </div>
...
const WeatherDemo = () => {
  ...
  return (
    <div className="space-y-4">
      <div className="premium-card bg-[#0A0603]/30 p-4">
      ...
      <div className="premium-card bg-[#0A0603]/40 border border-[#7EC47E]/20 p-3">
