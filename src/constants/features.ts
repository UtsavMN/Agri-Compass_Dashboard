export const features = [
  {
    id: "crops", icon: "🌾", title: "Crop Intelligence", subtitle: "AI-powered recommendations",
  ...
  {
    id: "fertilizer", icon: "🧪", title: "Fertilizer Optimizer", subtitle: "Precision soil nutrition",
    ...
    screenshot: "/screenshots/fertilizer.png", color: "#C9A84C",
    stats: ["N-P-K analysis", "Soil vitality score", "Cost optimised"],
  },
  {
    id: "market", icon: "📈", title: "Live Mandi Prices", subtitle: "Know your market before harvest",
  ...
  {
    id: "weather", icon: "🌦", title: "Weather & Advisory", subtitle: "Farm-specific forecasts",
    ...
    screenshot: "/screenshots/weather.png", color: "#60C0E0",
    stats: ["5-day forecast", "OpenWeather API", "Farm advisories"],
  },
  {
    id: "ai", icon: "🤖", title: "Krishi Mitra AI", subtitle: "Gemini-powered farm advisor",
    ...
    screenshot: "/screenshots/ai.png", color: "#C9A84C",
    stats: ["Google Gemini", "Kannada + English", "Contextual advice"],
  },
  {
    id: "voice", icon: "🎙", title: "Voice Navigation", subtitle: "ಮಾತನಾಡಿ, navigate ಮಾಡಿ",
  ...
  {
    id: "community", icon: "👥", title: "Kisan Community", subtitle: "Learn from your neighbours",
  ...
  {
    id: "schemes", icon: "🏛", title: "Government Schemes", subtitle: "Your benefits, found for you",
    ...
    screenshot: "/screenshots/schemes.png", color: "#C9A84C",
